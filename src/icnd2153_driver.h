...
#define SET_LATCH                                                                                                      \
  { GPIO.out_w1ts = PIN_MASK_LE; }
#define CLR_LATCH                                                                                                      \
  { GPIO.out_w1tc = PIN_MASK_LE; }
#define SET_CLOCK                                                                                                      \
  { GPIO.out_w1ts = PIN_MASK_CLK; }
#define CLR_CLOCK                                                                                                      \
  { GPIO.out_w1tc = PIN_MASK_CLK; }
#define SET_OE                                                                                                         \
  { GPIO.out_w1ts = PIN_MASK_OE; }
#define CLR_OE                                                                                                         \
  { GPIO.out_w1tc = PIN_MASK_OE; }
